...
//     if (startDate == null || endDate == null || selectedHos == null) {
...
//
//     final url =
//         'http://sofia.onedoc.ph:8000/api/registration?selectedhos=$selectedHos&end=$formattedEndDate&start=$formattedStartDate';
//
...
//   }
//
//   DropdownButtonFormField<String> _buildHospitalDropdown() {
...
//       items: [
//         DropdownMenuItem(
//           value: 'Asingan Community Hospital (ACH)',
//           child: Text('Asingan Community Hospital (ACH)'),
//         ),
//         DropdownMenuItem(
//           value: 'Bayambang District Hospital (BDH)',
//           child: Text('Bayambang District Hospital (BDH)'),
//         ),
...
//               ),
//               SizedBox(height: 16.0),
//               _buildHospitalDropdown(), // Add the hospital dropdown
//               SizedBox(height: 16.0),
//               ElevatedButton(
...
class _PdfScreenState extends State<VisitReport> {
  DateTime? startDate;
  DateTime? endDate;
  ...
  Future<void> _downloadPdf() async {
    ...
    final url =
        'http://sofia.onedoc.ph:8000/api/visitreport?selectedhos=$selectedHospital&end=$formattedEndDate&start=$formattedStartDate';
    ...
    if (response.statusCode == 200) {
      ...
      final dir = directories!.first;
      final file = File(
          '${dir.path}/visit_report_$formattedStartDate _to_$formattedEndDate _of_$selectedHospital.pdf');
      await file.writeAsBytes(response.bodyBytes);
              ...
              Center(
                child: Container(
                  child: DropdownButton<String>(
                    ...
                    hint: SizedBox(
                      width: 350, // Expand the width to fit the container
                      child: Row(
